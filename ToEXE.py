...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "La Marmota Mistica"
 
        #Project url
        self.project_url = "http://www.forodelavida.forochile.org"
 
        #Version of program
        self.project_version = "1.0"
 
        #License of the program
        self.license = "Marmota's Licence"
 
        #Auhor of program
        self.author_name = "Sergio Alvarez Medina"
        self.author_email = "sergioalvarez1998@outlook.com"
        self.copyright = "Copyright (c) 2017 Sergio Alvarez."
 
        #Description
        self.project_description = "Juego que narra la historia de la marmota mistica."
 
        #Icon file (None will use pygame default icon)
        self.icon_file = "img/icon.ico"
 
        #Extra files/dirs copied to game
        self.extra_datas = ["./bg","./bgm","./font","./img","./se","./sprites"]
